...
@section('title') Lịch khởi hành @endsection
@section('content')
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Lịch khởi hành</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Thông tin lịch khởi hành</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Thông tin lịch khởi hành</div>
					<div class="panel-body">
						<a href="{{ url('admin/departure_schedule/create') }}">Thêm mới</a>
						<div class="bootstrap-table">
							<div class="fixed-table-toolbar">
								<div class="pull-right search">
									{!! Form::open(['method' => 'GET', 'url' => 'admin/departure_schedule']) !!}
							...
							<div class="fixed-table-container">
								...
								<div class="fixed-table-body">
						    		...
						    		<thead>
						    			...
						    			<tbody>
						    				@if(isset($departure_schedule))
						    					@foreach($departure_schedule as $key => $item)
						    						<tr>
						    							<td><input type="checkbox" name=""></td>
						    							<td>{{ $key+1 }}</td>
						    							<td style="width:150px; height:100px; ">
						    								<img src="{{ url('uploads/departure_schedule/'.$item->image) }}" style="width:100%; height:100%; ">
						    							</td>
						    							<td>{{ $item->title }}</td>
						    							<td>
						    								<a href="{{ url('admin/departure_schedule/'.$item->id.'/edit') }}" class="btn" style="float:left;">Edit</a>
						    							{!! Form::open(['method' => 'DELETE', 'url' => 'admin/departure_schedule/'.$item->id]) !!}
						    								<a href="{{ url('admin/departure_schedule/'.$item->id.'/delete') }}"><button style="background:none;" type="submit" class="btn" onclick="return confirm('Are you sure?')">Delete</button></a>
						    							{!! Form::close() !!}	
						    							</td>
						    						</tr>
						    					@endforeach

...
@section('title') Thêm mới thông tin danh lam thắng cảnh @endsection
@section('content')
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Thêm mới thông tin danh lam thắng cảnh</h3>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-10">
							{!! Form::open(['type'=>'POST', 'url'=>'admin/attractions', 'files' => true, 'role'=>'form']) !!}

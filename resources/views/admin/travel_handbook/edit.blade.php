...
@section('title') Chỉnh sửa thông tin cẩm nang du lịch @endsection
@section('content')
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Edit thông tin cẩm nang du lịch</h3>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-10">
							{!! Form::model($travel_handbook,['method' => 'PATCH', 'url' => ['admin/travel_handbook',$travel_handbook->id ], 'files' => true ,'role' => 'form']) !!}
								...
								<div class="form-group" style="overflow: hidden; margin-top: -70px; float: right; margin-right: 150px;">
									...
									<img src="{{ url('uploads/travel_handbook/'.$travel_handbook->image)}}" style="width: 150px; height: 70px; ">
								</div>
							{!! Form::close() !!}

<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="margin-top:30px;">
		<ul class="nav menu">
			<li class="active"><a href="{{ url('admin') }}"><svg class="glyph stroked hourglass"><use xlink:href="#stroked-hourglass"/></svg> Home</a></li>
			<li><a href="{{ url('admin/category') }}"><svg class="glyph stroked tag"><use xlink:href="#stroked-tag"/></svg> Danh mục các tour</a></li>
			<li><a href="{{ url('admin/details') }}"><svg class="glyph stroked tag"><use xlink:href="#stroked-tag"/></svg> Thông tin chi tiết</a></li>		
			<li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-1"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Tin tức du lịch 
				</a>
			...
			<li class="parent ">
				<a href="#">
					<span data-toggle="collapse" href="#sub-item-2"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Dịch vụ
				</a>
